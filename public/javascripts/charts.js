...
(function (window, $, echarts) {
    var _ = function () {
        ...
        let territory = document.querySelector("#territory-select");
        let currentValue = territory.options[territory.selectedIndex].getAttribute("value");
        console.log(currentValue);

        $.ajax({
            url: `/dashboard/charts_data?territory_name=${currentValue}`,
            method: "GET",
            dataType: "json",
    ...
    $("#territory-select").change(event => {
        let select =  event.currentTarget;
        let index = select.selectedIndex;
        let currentOption = select.options[index];
        let currentValue = currentOption.getAttribute("value");
